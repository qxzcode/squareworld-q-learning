...
public:
    ...
    static constexpr uint64_t REPLAY_MEMORY_SIZE = 500;
    static constexpr uint64_t TRAIN_LOOPS = 100;
    static constexpr unsigned HIDDEN_LAYERS = 1;
    static constexpr unsigned HIDDEN_LAYER_NEURONS = 6;
